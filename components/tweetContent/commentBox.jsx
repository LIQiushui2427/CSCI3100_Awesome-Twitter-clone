...
const CommentBox = ({ authorname='test', authorid='someone_example',time='1h', content, picture,likes='0', retweets='0', onLike, onComment, onRetweet }) => (
  ...
  <div className="flex items-start p-4">
    <Avatar src="https://picsum.photos/id/1005/40/40" alt="Test" />
    <div className="ml-4">
      <div className="flex items-centerl">
        <textarea name="commentText" placeholder="Tweet your reply" cols={60} rows={3} className="w-full resize-none bg-transparent caret-white focus:outline-none text-xlon  " />
      </div>
      <div className="flex items-center">
        ...
        <div className="pr-5 justify-self-end">
