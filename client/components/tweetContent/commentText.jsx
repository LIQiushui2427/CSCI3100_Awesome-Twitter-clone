          ...
          <div className="flex items-start p-4">
            ...
            <div className="mt-4 flex justify-between w-full">
              ...
              <div className="flex justify-between">
                <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-3 rounded-lg" onClick={handleCancelReply}>Cancel</button>
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded-lg ml-2" onClick={handleSendReply}>Send</button>
              </div>
            </div>
          )}
          {showQuotedText && (
