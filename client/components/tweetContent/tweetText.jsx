...
const TweetText = ({ authorname='test', authorid='someone_example',time='1h', content,avatarpic='https://www.w3schools.com/howto/img_avatar.png', picture='https://ksbeeper.files.wordpress.com/2020/11/samplepic.png',nopic="false", likes='0', retweets='0', onLike, onComment, onRetweet }) => (
